...
:root {
  ...
  --clr-mc: #2196f3;
  --clr-bluePrimary: #007bff;
  --clr-blueHover: #0069d9;
  ...
  --clr-grey-11: gray94 hsl(0, 0%, 91%);
  --clr-grey-12: gray94 hsl(0, 0%, 98%);
  --clr-white: #fff;
  ...
  --clr-gr1-9: #808080;
  --clr-gr1-10: #6f6f6f;
  --my-gradient: linear-gradient(white, black);
...
.blockquote {
  background: #f1f1f1;
  border-left: 10px solid var(--clr-gr1-9);
  font-size: 16px;
  font-weight: 500;
  margin: 25px 0;
...
/*varianta butoane firme display btn-block*/
...
button[data-tool-tip]::before {
  ...
  transition: transform ease-out 150ms, bottom ease-out 120ms;
}

/*HOVER TREBUIE SA FIE IN MIJLOC!!!*/
...
.fancy-link::after {
  ...
  width: 100%;
  height: 2px;
  background-color: var(--clr-mc, red);
  /*background-color: #2196f3;*/
  transform: scaleX(0);
...
/*harta localizare varianta mare*/
#localizare_canvas {
  height: 600px;
  width: 100%;
  border: 0;
