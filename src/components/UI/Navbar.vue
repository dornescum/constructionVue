<template>
  <div>
    <b-navbar toggleable="lg" type="dark" variant="light">
      <b-navbar-brand to="/">
        <img src="../../assets/img/rsz_firma-74.png" alt="">
      </b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <b-nav-item to="/InscriereFirma">Inscriere Firma</b-nav-item>
          <b-nav-item to="/Localizare">Localizare</b-nav-item>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-form>
            <b-form-input size="sm" class="mr-sm-2" style="width: 40%" placeholder="Search"
                         ></b-form-input>
...
.navbar-toggler, .navbar-toggler:active, .navbar-toggler:hover {
  color: black;
  background-color: var(--clr-gr1-5);
  /*border-color: var(--clr-mc);*/
  border: var(--clr-mc) 2px solid;
}
