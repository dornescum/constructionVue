...
<section>
  <div class="container mt-2 mb-3" >
    ...
    <div class="row">
      ...
      <!-- start blog -->
      <div class="col-lg-4 sm-margin-30px-bottom mt-1 mb-1">
        <div class="card border-0 shadow h-100">
          <a href="#">
            <img class="card-img-top rounded" src="https://images.unsplash.com/photo-1608699565448-9492aaf3c708?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1120&q=80" alt="" />
          </a>
      ...
      <div class="col-lg-4 sm-margin-30px-bottom mt-1 mb-1">
        <div class="card border-0 shadow h-100">
          <a href="#">
            <img class="card-img-top rounded" src="https://images.unsplash.com/photo-1607370854756-4ad5e482dc54?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80" alt="" />
          </a>
          <div class="card-body padding-30px-all">
            <h5 class="card-title font-size22 font-weight-500 magin-20px-bottom">
      ...
      <div class="col-lg-4 mt-1 mb-1">
        <div class="card border-0 shadow h-100">
          <a href="#">
            <img class="card-img-top rounded" src="https://images.unsplash.com/photo-1607522792773-79add05b80b6?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" alt="" />
          </a>
          <div class="card-body padding-30px-all">
            <h5 class="card-title font-size22 font-weight-500 magin-20px-bottom">
